    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Selecciona una temática y todo el sitio cambiará de colores,
            ...
            >
              ...
              <div className="flex gap-1 mb-3">
                <div
                  ...
                  style={{ background: colors?.gradientFrom || "#7c3aed" }}
                />
                <div
                  className="h-6 flex-1 rounded"
                  style={{ background: colors?.gradientTo || "#3b82f6" }}
                />
              </div>
              ...
              {decorations?.accentEmojis && (
                <div className="flex gap-1 mt-2">
                  {(decorations.accentEmojis as string[]).map(
                    (e: string, i: number) => (
      ...
      {activeTheme && (
        <div className="p-4 rounded-xl bg-muted/30 border border-border">
          ...
          <div className="flex flex-wrap gap-2">
            {Object.entries((activeTheme.colors as any) || {}).map(
              ([key, value]) => {
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-sm font-semibold">
          Gestión de Eventos ({events?.length || 0})
        </h2>
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="bg-card border-border max-w-lg">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <Label className="text-xs">Nombre Sala</Label>
                  <Input
                    className="mt-1"
                    value={form.roomName}
                    onChange={(e) =>
                ...
                <div>
                  <Label className="text-xs">Dueño Sala</Label>
                  <Input
                    className="mt-1"
      ...
      <div className="space-y-2">
        {(events || []).map((item) => (
          <div
            key={item.id}
            className="flex items-center justify-between bg-secondary/30 rounded-lg px-3 py-2 border border-border"
          >
            <div>
              <p className="text-sm">{item.title}</p>
              <p className="text-[10px] text-muted-foreground">
                {item.date} · {item.time} · Sala: {item.roomName}
              </p>
            </div>
            <Button
              variant="ghost"
              ...
              <TableRow key={u.id} className="border-border">
                ...
                <TableCell>
                  <Select
                    value={u.role}
                    onValueChange={(v) =>
                      updateMutation.mutate({ id: u.id, data: { role: v } })
                    }
                  >
                ...
                <TableCell>
                  <Badge
                    variant="outline"
                    className={`text-[9px] ${u.approved ? "border-green-500/30 text-green-400" : "border-yellow-500/30 text-yellow-400"}`}
                  >
                ...
                <TableCell>
                  {!u.approved && (
                    <Button
                      size="sm"
                      variant="outline"
                      className="text-[10px] h-6 px-2 border-green-500/30 text-green-400 hover:bg-green-500/10"
                      onClick={() =>
      ...
      <div className="space-y-3 max-w-lg">
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              setDjForm((p) => ({ ...p, currentDj: e.target.value }))
            }
        ...
        <div>
          ...
          <Input
            ...
            value={djForm.nextDj}
            onChange={(e) =>
              setDjForm((p) => ({ ...p, nextDj: e.target.value }))
            }
        ...
        <div>
          ...
          <Textarea
            ...
            onChange={(e) =>
              setDjForm((p) => ({ ...p, djMessage: e.target.value }))
            }
        ...
        <div className="flex gap-2">
          <Select value={selectedUserId} onValueChange={setSelectedUserId}>
            <SelectTrigger
              ...
              data-testid="select-points-user"
            >
...
function ConfigAdmin() {
  ...
  if (config && !loaded) {
    setForm({
      radioService: config.radioService || "azuracast",
  ...
  return (
    <div className="space-y-4 max-w-lg">
      ...
      <div
        className={`p-4 rounded-xl border ${config?.maintenanceMode ? "bg-yellow-500/10 border-yellow-500/30" : "bg-green-500/10 border-green-500/30"}`}
      >
          ...
          <div>
            ...
            <p className="text-[10px] text-muted-foreground mt-0.5">
              {config?.maintenanceMode
                ...
                : "Todos pueden acceder al sitio normalmente."}
            </p>
          </div>
          <Button
            size="sm"
      ...
      <div className="space-y-3">
        <div>
          ...
          <Select
            value={form.radioService}
            onValueChange={(v) => setForm((p) => ({ ...p, radioService: v }))}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              ...
              <SelectItem value="liquidsoap">
                Liquidsoap (harbor JSON)
              </SelectItem>
            </SelectContent>
          </Select>
        </div>
        {form.radioService === "zenofm" ? (
          <>
            <div>
              <Label className="text-xs text-muted-foreground mb-1.5 block">
                URL Metadata (SSE) de ZenoFM
              </Label>
              <Input
                placeholder="https://api.zeno.fm/mounts/metadata/subscribe/tu_mount_id"
                value={form.apiUrl}
                onChange={(e) =>
              ...
              <p className="text-[10px] text-muted-foreground mt-1">
                La encuentras en Zeno Tools → Broadcast Settings. Usa el mount
                point sin el sufijo "/source".
              </p>
            </div>
            <div>
              <Label className="text-xs text-muted-foreground mb-1.5 block">
              ...
              <Input
                placeholder="https://stream.zeno.fm/tu_mount_id"
                value={form.listenUrl}
                onChange={(e) =>
                  setForm((p) => ({ ...p, listenUrl: e.target.value }))
                }
                data-testid="input-config-listen-url"
              />
            </div>
            <p className="text-[10px] text-muted-foreground bg-secondary/40 rounded-lg p-2">
              ZenoFM no reporta el nombre del locutor en vivo. El avatar y
              nombre que se muestran en el reproductor son los del DJ registrado
              en el Panel DJ.
            </p>
          </>
          ...
          <>
            <div>
              <Label className="text-xs text-muted-foreground mb-1.5 block">
                URL status-json.xsl de Icecast
              </Label>
              <Input
                placeholder="https://tu-servidor.com:8000/status-json.xsl"
                value={form.apiUrl}
                onChange={(e) =>
                  setForm((p) => ({ ...p, apiUrl: e.target.value }))
                }
            ...
            <div>
              ...
              <Input
                placeholder="https://tu-servidor.com:8000/tu-mount"
                value={form.listenUrl}
                onChange={(e) =>
                  setForm((p) => ({ ...p, listenUrl: e.target.value }))
                }
            ...
            <p className="text-[10px] text-muted-foreground bg-secondary/40 rounded-lg p-2">
              Icecast tampoco reporta el locutor en vivo por nombre. El
              reproductor muestra el avatar del DJ registrado en el Panel DJ.
            </p>
          </>
          ...
          <>
            <div>
              <Label className="text-xs text-muted-foreground mb-1.5 block">
                URL Stats JSON de SHOUTcast
              </Label>
              <Input
                placeholder="https://tu-servidor.com:8000/stats?sid=1&json=1"
                value={form.apiUrl}
                onChange={(e) =>
                  setForm((p) => ({ ...p, apiUrl: e.target.value }))
                }
            ...
            <div>
              ...
              <Input
                placeholder="https://tu-servidor.com:8000/stream"
                value={form.listenUrl}
                onChange={(e) =>
                  setForm((p) => ({ ...p, listenUrl: e.target.value }))
                }
            ...
            <p className="text-[10px] text-muted-foreground bg-secondary/40 rounded-lg p-2">
              SHOUTcast tampoco reporta el locutor en vivo por nombre. El
              reproductor muestra el avatar del DJ registrado en el Panel DJ.
            </p>
          </>
          ...
          <>
            <div>
              <Label className="text-xs text-muted-foreground mb-1.5 block">
                URL del endpoint harbor de Liquidsoap
              </Label>
              <Input
                placeholder="http://tu-servidor.com:7000/getmeta"
                value={form.apiUrl}
                onChange={(e) =>
                  setForm((p) => ({ ...p, apiUrl: e.target.value }))
                }
              ...
              />
              <p className="text-[10px] text-muted-foreground mt-1">
                Requiere registrar un endpoint HTTP con{" "}
                <code>harbor.http.register</code> en tu script .liq que devuelva
                JSON con <code>artist</code>/<code>title</code>.
              </p>
            </div>
            <div>
              <Label className="text-xs text-muted-foreground mb-1.5 block">
                URL Stream (normalmente el Icecast/SHOUTcast al que Liquidsoap
                transmite)
              </Label>
              <Input
                placeholder="https://tu-servidor.com:8000/tu-mount"
            ...
            <p className="text-[10px] text-muted-foreground bg-secondary/40 rounded-lg p-2">
              Liquidsoap no transmite audio directo al navegador; normalmente
              alimenta a un Icecast o SHOUTcast. El reproductor muestra el
              avatar del DJ registrado en el Panel DJ.
            </p>
          </>
        ) : (
          <>
...
function TeamAdmin() {
  ...
  const headonlyUrl = (u: string) =>
    u
      ? `https://www.habbo.es/habbo-imaging/avatarimage?user=${encodeURIComponent(u)}&size=s&headonly=1`
      : null;
    ...
    <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setForm((p) => ({ ...p, habboUsername: e.target.value }))
                  }
              ...
              <div>
                <Label className="text-xs">Motto (opcional)</Label>
                <Input
                  className="mt-1"
                  value={form.motto}
                  onChange={(e) =>
      ...
      <div className="space-y-2">
        {(team || []).map((m) => (
          <div
            key={m.id}
            className="flex items-center gap-3 bg-secondary/30 rounded-lg px-3 py-2 border border-border"
          >
            {headonlyUrl(m.habboUsername) && (
              <img
                src={headonlyUrl(m.habboUsername)!}
                alt={m.displayName}
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <Badge
                  variant="outline"
                  className={`text-[9px] capitalize ${ROLE_COLORS[m.role] || "border-border"}`}
                >
                  {m.role}
                </Badge>
              </div>
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="bg-card border-border max-w-md">
            <DialogHeader>
              <DialogTitle className="text-sm">Nueva Descarga</DialogTitle>
            </DialogHeader>
            <div className="space-y-3">
              <div>
                <Label className="text-xs">Título</Label>
              ...
              <Button
                ...
                onClick={() => createMutation.mutate(form)}
                disabled={
                  createMutation.isPending || !form.title || !form.fileUrl
                }
            ...
            {(downloads || []).map((d) => (
              <TableRow key={d.id} className="border-border">
                ...
                <TableCell>
                  <Badge
                    variant="outline"
                    className="text-[9px] border-border capitalize"
                  >
                    {d.category}
                  </Badge>
                </TableCell>
                ...
                <TableCell>
                  <Button
                    ...
                    data-testid={`button-delete-download-${d.id}`}
                  >
                    <Trash2 className="w-3.5 h-3.5" />
                  </Button>
                </TableCell>
...
function BannedSongsAdmin() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-sm font-semibold">
          Canciones Baneadas ({bannedSongs?.length || 0})
        </h2>
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button
          ...
          <DialogContent className="bg-card border-border max-w-md">
            <DialogHeader>
              <DialogTitle className="text-sm">Banear Canción</DialogTitle>
            </DialogHeader>
            <div className="space-y-3">
              <div>
                <Label className="text-xs">Título</Label>
                <Input
                  ...
                  data-testid="input-ban-song-title"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  data-testid="input-ban-song-artist"
                />
              </div>
              <div>
                ...
                <Textarea
                  ...
                  data-testid="input-ban-song-reason"
                />
              </div>
              <Button
                className="w-full bg-primary hover:bg-primary/80 text-white text-xs"
                onClick={() => createMutation.mutate(form)}
                disabled={
                  createMutation.isPending || !form.title || !form.artist
                }
...
function ContactsAdmin() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-sm font-semibold">
        Mensajes de Contacto ({messages?.length || 0})
      </h2>
      <div className="space-y-2">
        {(messages || []).map((msg) => (
          <div
            ...
            >
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <Badge
                    variant="outline"
                    className={`text-[9px] ${STATUS_STYLES[msg.status] || "border-border"}`}
                  >
              ...
              <div className="px-3 pb-3 border-t border-border/50 pt-2 space-y-2">
                ...
                <div className="flex gap-2 flex-wrap">
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    className="text-[10px] h-6 px-2 border-green-500/30 text-green-400"
                    onClick={() =>
                      updateStatusMutation.mutate({
                        id: msg.id,
                        status: "replied",
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    className="text-[10px] h-6 px-2 border-gray-500/30 text-gray-400"
                    onClick={() =>
                      updateStatusMutation.mutate({
                        id: msg.id,
                        status: "archived",
                    ...
                    data-testid={`button-mark-archived-${msg.id}`}
                  >
                    Archivar
                  </Button>
                </div>
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {(reports || []).map((report) => (
          <div
            key={report.id}
            className="bg-secondary/30 rounded-lg border border-border px-3 py-2"
          >
            <div className="flex items-start gap-3">
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 flex-wrap mb-1">
                  ...
                  <span className="text-[10px] text-muted-foreground">
                    Sender:{" "}
                    <span className="text-foreground">{report.senderName}</span>
                  </span>
                  <Badge
                    variant="outline"
                    className={`text-[9px] ${STATUS_STYLES[report.status] || "border-border"}`}
                  >
                    {STATUS_LABELS[report.status] || report.status}
                  </Badge>
                </div>
                <p className="text-xs text-muted-foreground truncate">
                  {report.subject || report.content?.slice(0, 80)}
                </p>
                {report.reason && (
                  <p className="text-[10px] text-muted-foreground mt-0.5">
                    Razón: {report.reason}
            ...
            <div className="flex gap-2 flex-wrap mt-2">
              <Button
                size="sm"
                variant="outline"
                className="text-[10px] h-6 px-2 border-orange-500/30 text-orange-400"
                onClick={() =>
                  updateStatusMutation.mutate({
                    id: report.id,
                    status: "warned",
                ...
                data-testid={`button-warn-report-${report.id}`}
              >
                Advertir
              </Button>
              <Button
                size="sm"
                variant="outline"
                className="text-[10px] h-6 px-2 border-red-500/30 text-red-400"
                onClick={() =>
                  updateStatusMutation.mutate({
                    id: report.id,
                    status: "banned",
                ...
                data-testid={`button-ban-report-${report.id}`}
              >
                Banear
              </Button>
              <Button
              ...
              <Button
                size="sm"
                variant="outline"
                className="text-[10px] h-6 px-2 border-destructive/30 text-destructive"
          ...
          <TableBody>
            {(logs || []).map((log, i) => (
              <TableRow key={log.id ?? i} className="border-border">
                ...
                <TableCell
                  className={`text-xs font-medium ${ACTION_COLOR(log.action)}`}
                >
                  {log.action}
                </TableCell>
...
function ShopAdmin() {
  ...
  const openEdit = (item: any) => {
    ...
    setForm({
      ...
      category: item.category || "decoracion",
      price: item.price || 0,
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-sm font-semibold">
          Gestión de Tienda ({products?.length || 0})
        </h2>
        <Button
          size="sm"
          className="bg-primary hover:bg-primary/80 text-white text-xs"
      ...
      <div className="space-y-2">
        {(products || []).map((p: any) => (
          <div
            key={p.id}
            className="flex items-center gap-2 bg-secondary/30 rounded-lg px-3 py-2 border border-border"
          >
            {p.imageUrl && (
              <img
                src={p.imageUrl}
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                {!p.isActive && (
                  <Badge
                    variant="outline"
                    className="text-[9px] border-gray-500/30 text-gray-400"
                  >
                    Inactivo
                  </Badge>
                )}
        ...
        <DialogContent className="bg-card border-border max-w-lg">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>
                <Label className="text-xs">Precio (SP)</Label>
                <Input
                  className="mt-1"
                  type="number"
                  min={0}
            ...
            <div>
              <Label className="text-xs">URL de preview (opcional)</Label>
              <Input
                className="mt-1"
                placeholder="https://..."
                value={form.previewUrl}
                onChange={(e) =>
                  setForm((p) => ({ ...p, previewUrl: e.target.value }))
                }
              />
            </div>
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className="flex items-end gap-2 pb-1">
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    onClick={() =>
                      setForm((p) => ({ ...p, isLimited: !p.isLimited }))
                    }
                    className={`text-xs px-2.5 py-1.5 rounded-lg border transition-colors ${form.isLimited ? "border-red-500/50 bg-red-500/10 text-red-400" : "border-border bg-secondary/30 text-muted-foreground"}`}
                  >
                    Limitado
                  </button>
                  <button
                    ...
                    className={`text-xs px-2.5 py-1.5 rounded-lg border transition-colors ${form.isActive ? "border-green-500/50 bg-green-500/10 text-green-400" : "border-border bg-secondary/30 text-muted-foreground"}`}
                  >
                    Activo
                  </button>
                </div>
...
function ForumAdmin() {
  ...
  const createCatMutation = useMutation({
    mutationFn: (data: any) =>
      apiRequest("POST", "/api/forum/categories", data, `Bearer ${token}`),
    onSuccess: () => {
  ...
  const updateCatMutation = useMutation({
    mutationFn: (data: any) =>
      apiRequest(
        "PUT",
        `/api/forum/categories/${editCat?.id}`,
        data,
        `Bearer ${token}`,
      ),
    onSuccess: () => {
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-sm font-bold uppercase tracking-wider text-white mb-1">
            Foro — Categorías y Hilos
          </h2>
          <p className="text-xs text-muted-foreground">
            Gestiona categorías del foro y modera los hilos de la comunidad.
          </p>
        </div>
        <Dialog open={catOpen} onOpenChange={setCatOpen}>
          ...
          <DialogContent className="bg-card border-border max-w-sm">
            <DialogHeader>
              <DialogTitle>Nueva Categoría de Foro</DialogTitle>
            </DialogHeader>
            <div className="space-y-3 pt-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  <Label className="text-xs">Icono (FA class)</Label>
                  <Input
                    className="mt-1 text-xs"
                    placeholder="fa-solid fa-comments"
                    value={catForm.icon}
                    onChange={(e) =>
                      setCatForm((p) => ({ ...p, icon: e.target.value }))
                    }
                  />
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {categories.map((cat: any) => (
          <div
            key={cat.id}
            className="p-4 rounded-xl border border-border bg-zinc-900/60 space-y-2"
          >
            <div className="flex items-center gap-2">
              <div
                className="w-8 h-8 rounded-lg flex items-center justify-center text-white text-sm"
                style={{ background: cat.color || "#7c3aed" }}
              >
      ...
      >
        <DialogContent className="bg-card border-border max-w-sm">
          ...
          <div className="space-y-3 pt-2">
            ...
            <Button
              className="w-full bg-primary text-white text-xs"
              disabled={!editForm.name || updateCatMutation.isPending}
              onClick={() => updateCatMutation.mutate(editForm)}
      ...
      >
        <DialogContent className="bg-card border-border max-w-sm">
          ...
          <div className="space-y-3 pt-2">
            <p className="text-xs text-muted-foreground">
              ¿Seguro que quieres eliminar esta categoría? Los hilos asociados
              no se eliminarán, pero quedarán sin categoría visible.
            </p>
            <div className="flex gap-2">
              <Button
                variant="outline"
              ...
              <Button
                ...
                onClick={() =>
                  deleteCatId !== null && deleteCatMutation.mutate(deleteCatId)
                }
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Gestiona las solicitudes de ayuda y soporte de los usuarios.
        </p>
      </div>
          ...
          <TableBody>
            {tickets.length === 0 ? (
              ...
              tickets.map((ticket: any) => (
                <TableRow
                  key={ticket.id}
                  className="border-border hover:bg-zinc-800/40"
                >
                  ...
                  <TableCell>
                    <span
                      className={`text-[10px] px-2 py-1 rounded-full border font-bold ${statusColor[ticket.status] || statusColor["open"]}`}
                    >
                      {ticket.status === "open"
                        ? "Abierto"
...
function RoomsAdmin() {
  ...
  const { data: rooms = [], refetch } = useQuery<any[]>({
    ...
    queryFn: async () =>
      (
        await apiRequest(
          "GET",
          "/api/rooms?includeInactive=true",
          undefined,
          `Bearer ${token}`,
        )
      ).json(),
  ...
  const createMutation = useMutation({
    mutationFn: (data: any) =>
      apiRequest("POST", "/api/rooms", data, `Bearer ${token}`),
    onSuccess: () => {
    ...
    onError: () =>
      toast({ title: "Error al crear sala", variant: "destructive" }),
  });

  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: number; data: any }) =>
      apiRequest("PUT", `/api/rooms/${id}`, data, `Bearer ${token}`),
    onSuccess: () => {
      toast({ title: "Sala actualizada" });
      setOpen(false);
      setEditRoom(null);
      setForm({ ...emptyForm });
      refetch();
    ...
    onError: () =>
      toast({ title: "Error al actualizar sala", variant: "destructive" }),
  });

  const deleteMutation = useMutation({
    mutationFn: (id: number) =>
      apiRequest("DELETE", `/api/rooms/${id}`, undefined, `Bearer ${token}`),
    onSuccess: () => {
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Gestiona las salas Habbo destacadas de la comunidad HabboSpeed.
          </p>
        </div>
        <Button
          size="sm"
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="bg-card border-border max-w-md">
          <DialogHeader>
            <DialogTitle>
              {editRoom ? "Editar Sala" : "Nueva Sala Comunitaria"}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-3 pt-2">
            <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <Label className="text-xs">Dueño (Habbo Nick)</Label>
                <Input
                  className="mt-1 text-xs"
                  value={form.ownerHabbo}
                  onChange={(e) =>
                    setForm((p) => ({ ...p, ownerHabbo: e.target.value }))
                  }
                />
              </div>
              <div>
                <Label className="text-xs">Código de Sala</Label>
                <Input
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  {["social", "oficial", "musica", "vip", "evento", "otro"].map(
                    (c) => (
                      <SelectItem
                        key={c}
                        value={c}
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`text-xs px-3 py-1.5 rounded-lg border transition-colors ${form.isActive ? "border-green-500/50 bg-green-500/10 text-green-400" : "border-border bg-secondary/30 text-muted-foreground"}`}
              >
                Activa
              </button>
              <button
                ...
                className={`text-xs px-3 py-1.5 rounded-lg border transition-colors ${form.featured ? "border-yellow-500/50 bg-yellow-500/10 text-yellow-400" : "border-border bg-secondary/30 text-muted-foreground"}`}
              >
                Destacada ⭐
              </button>
            </div>
              ...
              rooms.map((room: any) => (
                ...
                >
                  ...
                  <TableCell>
                    <div className="flex items-center gap-1.5">
                      <span
                        className={`w-1.5 h-1.5 rounded-full ${room.isActive ? "bg-green-400" : "bg-zinc-500"}`}
                      ></span>
                      {room.featured && (
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-xs text-muted-foreground">
          Gestiona las membresías VIP de los usuarios y sus beneficios.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {tiers.map((tier) => {
          const count = memberships.filter(
            (m: any) => m.tier === tier && m.isActive,
          ).length;
          return (
            <div
              key={tier}
              className={`p-3 rounded-xl border text-center ${tierColors[tier] || "border-border"}`}
            >
              <p className="text-xl font-black">{count}</p>
              <p className="text-[10px] uppercase tracking-wider mt-0.5 font-bold capitalize">
                {tier}
              </p>
            </div>
          );
            ...
            {memberships.length === 0 ? (
              ...
              memberships.map((m: any) => (
                ...
                >
                  ...
                  <TableCell>
                    <span
                      className={`text-[10px] px-2 py-1 rounded-full border font-bold capitalize ${tierColors[m.tier] || "border-border"}`}
                    >
                      {m.tier}
                    </span>
                  </TableCell>
                  <TableCell className="text-xs text-muted-foreground">
                    {m.expiresAt
                      ? new Date(m.expiresAt).toLocaleDateString("es-MX")
                      : "—"}
                  </TableCell>
                  <TableCell>
                    <span
                      className={`text-[10px] px-2 py-1 rounded-full border font-bold ${m.isActive ? "bg-green-500/10 text-green-400 border-green-500/30" : "bg-zinc-500/10 text-zinc-400 border-zinc-500/30"}`}
                    >
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <SelectTrigger className="h-7 text-[10px] w-24 bg-zinc-800 border-border">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          {tiers.map((t) => (
...
function AlliancesAdmin() {
  ...
  const handleSubmit = () => {
    if (!form.name || !form.logoUrl) {
      toast({
        title: "Error",
        description: "El nombre y el logo son requeridos",
        variant: "destructive",
      });
      return;
    }
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-sm font-bold uppercase tracking-wider text-white">
            Nuestras Alianzas ({alliances.length})
          </h2>
          <p className="text-xs text-muted-foreground">
            Gestiona las webs amigas y alianzas del portal de radio.
          </p>
        </div>
        <Dialog
          open={open}
            ...
            <div className="space-y-3">
              ...
              <div>
                <Label className="text-xs">
                  URL del Logo (imgur, beeimg, habbo) *
                </Label>
                <Input
                  className="mt-1"
                  placeholder="https://..."
              ...
              <Button
                className="w-full bg-primary hover:bg-primary/80 text-white text-xs mt-2"
          ...
          <TableBody>
            {isLoading ? (
              <TableRow>
                <TableCell
                  colSpan={6}
                  className="text-center text-xs py-8 text-muted-foreground"
                >
                  Cargando...
                </TableCell>
              </TableRow>
                ...
                >
                  <TableCell>
                    <img
                      src={a.logoUrl}
                      alt={a.name}
                      className="h-8 w-8 object-contain bg-black/10 rounded"
                      onError={(e) => {
                        (e.target as HTMLImageElement).src =
                          "/habbo-radio/frank_small_03.gif";
                      }}
                  ...
                  <TableCell>
                    <span
                      className={`text-[9px] font-bold px-2 py-0.5 rounded-full border ${a.isActive ? "bg-green-500/10 text-green-400 border-green-500/30" : "bg-zinc-500/10 text-zinc-400 border-zinc-500/30"}`}
                    >
              ...
              <div className="bg-gradient-to-r from-primary/10 via-card to-card border border-primary/20 rounded-xl p-6 relative overflow-hidden">
                <div className="relative z-10 max-w-md">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Este es el centro de control de HabboSpeed. Usa el menú
                    lateral para gestionar la radio, configurar temas, aprobar
                    noticias y moderar la comunidad.
                  </p>
                </div>
                {user.habboUsername && (
                  <img
