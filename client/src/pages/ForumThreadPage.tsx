  ...
  return (
    <div className="flex flex-col items-center gap-1.5 flex-shrink-0">
      {username ? (
        <img
          ...
          onError={(e) => {
            ...
            fb.className =
              "w-10 h-10 rounded-xl bg-primary/20 flex items-center justify-center text-primary text-sm font-bold";
      ...
      {isOP && (
        <Badge
          variant="outline"
          className="text-[8px] border-primary/30 text-primary/80 px-1 py-0"
        >
          OP
        </Badge>
      )}
  ...
  if (!thread) {
    return (
      <div className="p-6 text-center">
        ...
        <Link href="/forum" className="text-primary text-sm mt-2 inline-block">
          \u2190 Volver al Foro
        </Link>
      </div>
    );
