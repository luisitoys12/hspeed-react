...
export default function FutbolHubPanel() {
  const [tab, setTab] = useState<"forecast" | "adventure" | "mini">("forecast");

  return (
    <section className="site-panel-strong p-4 rounded-2xl overflow-hidden" data-testid="futbolhub-panel">
      <div className="flex items-center justify-between mb-3">
        <div>
          <h3 className="text-sm font-extrabold text-foreground">Fútbol Hub — Zona Deportiva</h3>
          <p className="text-[11px] text-muted-foreground mt-1">Predicciones, aventuras, estampas y minijuegos retro para la comunidad.</p>
        </div>
      ...
      <div>
        {tab === "forecast" && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="bg-card border border-border rounded-lg p-3">
              ...
              <Link href="/futbol-hub/pronosticos" className="inline-block mt-3 text-xs text-primary font-bold hover:underline">Ir a pronósticos →</Link>
            </div>
            ...
            <div className="bg-card border border-border rounded-lg p-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs font-bold">Ranking de Expertos</p>
                  <p className="text-[11px] text-muted-foreground mt-1">Top jugadores por aciertos y participación.</p>
                </div>
              </div>
              <Link href="/futbol-hub/ranking" className="inline-block mt-3 text-xs text-primary font-bold hover:underline">Ver ranking →</Link>
            </div>
            ...
            <div className="bg-card border border-border rounded-lg p-3">
              ...
              <Link href="/futbol-hub/equipos" className="inline-block mt-3 text-xs text-primary font-bold hover:underline">Crear equipo →</Link>
            </div>
          </div>
        )}
        ...
        {tab === "adventure" && (
          <div className="space-y-3">
            <div className="bg-card border border-border rounded-lg p-4">
              ...
              <Link href="/futbol-hub/aventura" className="inline-block mt-3 text-xs text-primary font-bold hover:underline">Empezar aventura →</Link>
            </div>
          </div>
        )}
        ...
        {tab === "mini" && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="bg-card border border-border rounded-lg p-3">
              <p className="text-xs font-bold">Juego de Penales</p>
              <p className="text-[11px] text-muted-foreground mt-1">Sistemas de bracket y partidas rápidas dentro del hotel.</p>
              <Link href="/futbol-hub/mini/rapido" className="inline-block mt-3 text-xs text-primary font-bold hover:underline">Unirse →</Link>
            </div>
            <div className="bg-card border border-border rounded-lg p-3">
              ...
              <Link href="/futbol-hub/mini/sorteos" className="inline-block mt-3 text-xs text-primary font-bold hover:underline">Participar →</Link>
            </div>
          </div>
        )}
      </div>
