    ...
    <Card className="h-full">
      <CardHeader>
        <div className="flex flex-col items-center text-center">
            <Image src="https://www.habbo.es/habbo-imaging/avatarimage?user=hspeed&headonly=1&size=l" alt="Ekus FM" width={80} height={80} className="rounded-full border-4 border-primary mb-4" />
